...
namespace Sheng.Weixin.OfficialAccount
{
    ...
    */
    public class TagsApi
    {
        ...
        /// <returns></returns>
        public static WeixinRequestApiResult<WeixinTag> Create(string access_token, WeixinCreateTagArgs args)
        {
            WeixinRequestApiResult<WeixinTag> result =
               new WeixinRequestApiResult<WeixinTag>();
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static WeixinRequestApiResult<WeixinGetTagListResult> GetTagList(string access_token)
        {
            WeixinRequestApiResult<WeixinGetTagListResult> result =
               new WeixinRequestApiResult<WeixinGetTagListResult>();
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static WeixinRequestApiResult Update(string access_token, WeixinTag args)
        {
        ...
        /// <returns></returns>
        public static WeixinRequestApiResult Remove(string access_token, int tagId)
        {
            WeixinRequestApiResult result = new WeixinRequestApiResult();
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static WeixinRequestApiResult BatchTagging(string access_token, WeixinTagBatchTaggingArgs args)
        {
            WeixinRequestApiResult result = new WeixinRequestApiResult();
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static WeixinRequestApiResult BatchUntagging(string access_token, WeixinTagBatchTaggingArgs args)
        {
            WeixinRequestApiResult result = new WeixinRequestApiResult();
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static WeixinRequestApiResult<WeixinGetUserTagListResult> GetUserTagList(string access_token, string openId)
        {
            WeixinRequestApiResult<WeixinGetUserTagListResult> result =
               new WeixinRequestApiResult<WeixinGetUserTagListResult>();
