...
namespace Sheng.Weixin.OfficialAccount
{
    ...
    public class GroupMessageApi
    {
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static WeixinRequestApiResult<WeixinGroupMessageGetStatusResult> GetStatus(string access_token, string msgId)
        {
            WeixinRequestApiResult<WeixinGroupMessageGetStatusResult> result =
               new WeixinRequestApiResult<WeixinGroupMessageGetStatusResult>();
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static WeixinRequestApiResult<WeixinGroupMessagePreviewResult> Preview(string access_token, WeixinGroupMessagePreviewArgs args)
        {
            WeixinRequestApiResult<WeixinGroupMessagePreviewResult> result =
               new WeixinRequestApiResult<WeixinGroupMessagePreviewResult>();
