...
namespace Sheng.Weixin.OfficialAccount
{
    ...
    public class GroupApi
    {
        ...
        /// <returns></returns>
        public static WeixinRequestApiResult<WeixinGroup> Create(string access_token, WeixinCreateGroupArgs args)
        {
            WeixinRequestApiResult<WeixinGroup> result =
               new WeixinRequestApiResult<WeixinGroup>();
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static WeixinRequestApiResult<WeixinGetGroupListResult> GetGroupList(string access_token)
        {
            WeixinRequestApiResult<WeixinGetGroupListResult> result =
               new WeixinRequestApiResult<WeixinGetGroupListResult>();
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static WeixinRequestApiResult Update(string access_token, WeixinGroup args)
        {
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public static WeixinRequestApiResult SetUserGroup(string access_token, WeixinSetUserGroupArgs args)
        {
            WeixinRequestApiResult result = new WeixinRequestApiResult();
        ...
        /// <returns></returns>
        public static WeixinRequestApiResult Remove(string access_token, int groupId)
        {
            WeixinRequestApiResult result = new WeixinRequestApiResult();
