...
namespace Sheng.Weixin.OfficialAccount
{
    public static class  UserApi
    {
        ...
        /// <returns></returns>
        public static WeixinRequestApiResult<WeixinUser> GetUserInfo(string access_token, string openid)
        {
            WeixinRequestApiResult<WeixinUser> result =
                new WeixinRequestApiResult<WeixinUser>();
