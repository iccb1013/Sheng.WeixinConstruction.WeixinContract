...
namespace Sheng.Weixin.OfficialAccount
{
    ...
    public static class QRCodeApi
    {
        ...
        /// <returns></returns>
        public static WeixinRequestApiResult<WeixinCreateQRCodeResult> Create(string access_token, WeixinCreateQRCodeArgs args)
        {
            WeixinRequestApiResult<WeixinCreateQRCodeResult> result =
               new WeixinRequestApiResult<WeixinCreateQRCodeResult>();
