...
namespace Sheng.Weixin
{
    ...
    public class WeixinRequestApiResult
    {
        ...
        public virtual bool Successful
        {
            get
            {
                if (HttpRequestResult.Successful && ApiError != null && ApiError.Successful)
                    return true;
                else
                    return false;
            }
        ...
        public string Message
        {
            get
            {
                if (HttpRequestResult != null && HttpRequestResult.Successful == false)
                    return HttpRequestResult.Exception.Message;

                if (ApiError != null && ApiError.Successful == false)
                {
    ...
    public class WeixinRequestApiResult<T> : WeixinRequestApiResult where T : class
    {
        public T ApiResult
        {
            get;
        ...
        public override bool Successful
        {
            get
            {
                if (HttpRequestResult != null && HttpRequestResult.Successful && ApiResult != null)
                    return true;
                else
                    return false;
            }
